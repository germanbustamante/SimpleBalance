...
class GetMonthlyExpensesUseCase(
    ...
    private fun getDaysInMonth(year: Int, month: Int): Int {
        return when (month) {
            JANUARY, MARCH, MAY, JULY, AUGUST, OCTOBER, DECEMBER -> DAYS_IN_MONTH_31
            APRIL, JUNE, SEPTEMBER, NOVEMBER -> DAYS_IN_MONTH_30
            FEBRUARY -> if (isLeapYear(year)) DAYS_IN_FEBRUARY_LEAP else DAYS_IN_FEBRUARY_COMMON
    ...
    companion object {
        ...
        private const val DAYS_IN_FEBRUARY_COMMON = 28
