package com.germandebustamante.model
...
data class Expense(
     ...
     */
    fun amountInCents(): Long = (amount * BigDecimal(BIG_DECIMAL_100)).toLong()
     ...
     */
    fun withUpdatedTimestamp(
        newUpdatedAt: Instant =
            Instant.fromEpochMilliseconds(System.currentTimeMillis()),
    ): Expense = copy(updatedAt = newUpdatedAt)
